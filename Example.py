...
common = [  'P',                    # Momentum
            ...
            'ETA',                  # Pseudorapidity
            'IP_OWNPV',             # Impact parameter "OWNPV": primary vertex reconstructed with the tracks of other products of pp collision
            'IPCHI2_OWNPV',]        # How to apply???CHi2: Staticical test to see if a variable follows a given probability function

Bvars  = [  'DTF_M',                # Reconstructed invarient mass
            'DOCA',                 # Distance of closest approach, high for background
            'ENDVERTEX_CHI2',       # ---
...
muvars = [  'ProbNNmu',             # Probability neural network mu?
